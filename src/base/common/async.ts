...
export function createCancelablePromise<T>(
  ...
  return <CancelablePromise<T>><unknown>new (class {
    ...
    public then<TResult1 = T, TResult2 = never> (resolve?: ((value: T) => TResult1 | Promise<TResult1>) | undefined | null, reject?: ((reason: any) => TResult2 | Promise<TResult2>) | undefined | null): Promise<TResult1 | TResult2> {
      return promise.then(resolve, reject);
    }

    public catch<TResult = never> (reject?: ((reason: any) => TResult | Promise<TResult>) | undefined | null): Promise<T | TResult> {
...
export async function executeDelayedDebugger(millis: number): Promise<void> {
  if (!isDev) {
    return;
  }
