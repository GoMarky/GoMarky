 ...
 *
 *  Объект прямогоульника не входящий в стандартную спецификацию GeoJSON.
 *  Массив не должен состоять из более чем двух элементов.
 */
export interface Rectangle extends GeoJsonObject {
  type: 'Rectangle';
  coordinates: Position[][];
}
...
/**
 * @description
 * Ellipse geometry object.
 *
 *  Объект овала / круга не входящий в стандартную спецификацию GeoJSON.
 *  Массив не должен состоять из более чем двух элементов.
 */
export interface Ellipse extends GeoJsonObject {
  type: 'Ellipse';
  coordinates: Position[][];
}
