...
import { exists, readdir } from '@/base/node/pfs';

import { CHANGE_BUFFER_DELAY } from '@/platform/files/node/watcher/watcherService';
import { basename, join } from 'path';
import { normalizeNFC } from '@/base/common/normalize';

import { isMacintosh } from '@/base/platform';
