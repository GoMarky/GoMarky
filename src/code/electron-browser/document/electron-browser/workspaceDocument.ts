...
import { basename, isEqualOrParent, joinPath, URI } from '@/base/common/uri';
import { generateUuid } from '@/base/common/uuid';
import { IWorkspacePage } from '@/code/electron-browser/page/common/page';

import { IFileService } from '@/platform/files/common/files';
import { WorkspacePage } from '@/code/electron-browser/page/electron-browser/page';
import { IInstantiationService } from '@/platform/instantiation/common/instantiation';

import { CriticalError } from '@/base/common/errors';
import { resolveAnnotationPath } from '@/platform/workspace/common/workspace';
import { ITextureService } from '@/code/common/texture/texture';
