...
import { isDev, isLinux, isMacintosh } from '@/base/platform';
import { ICodeWindow, IWindowCreationOptions } from '@/platform/window/electron-main/window';
...
import { IWorkspaceId } from '@/platform/workspace/common/workspace';
