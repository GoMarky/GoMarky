import {
  ...
  IWindowState,
  WindowMode,
} from '@/platform/window/electron-main/window';
import { isDev, isMacintosh, isWindows } from '@/base/platform';
...
import { getLastActiveWindow } from '@/code/electron-main/window';
import {
  getWorkspaceId,
...
import { IWindowsCountChangedEvent } from '@/platform/windows/electron-main/windowsService';
import { IInternalNativeOpenDialogOptions } from '@/platform/windows/common/windows';

import { basename, URI } from '@/base/common/uri';
import { IWorkspaceIdentifier } from '@/platform/workspaces/common/workspaces';
import { IWorkspace, IWorkspaceId } from '@/platform/workspace/common/workspace';

import { restoreWindowsState } from '@/platform/windows/electron-main/state';
