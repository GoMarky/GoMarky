import { IRequestRegister, IRequestService } from '@/platform/request/common/requestService';
...
import {
  ...
  IErrorInterceptor,
} from '@/platform/request/common/interceptor';
import { BaseTransformer } from '@/platform/request/common/transformer';
import { HTTPRequest, ResponseInstance } from '@/platform/request/common/request';
import { Class } from '@/typings/utils';
