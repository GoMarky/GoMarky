...
export abstract class ContextKeyExpr {
  ...
  public static and(...expr: (ContextKeyExpr | undefined | null)[]): ContextKeyExpr | undefined {
    return ContextKeyAndExpr.create(expr);
  }

  public static or(...expr: (ContextKeyExpr | undefined | null)[]): ContextKeyExpr | undefined {
...
export class ContextKeyAndExpr implements ContextKeyExpr {
  public static create(_expr: (ContextKeyExpr | null | undefined)[]): ContextKeyExpr | undefined {
  ...
  private static _normalizeArr(arr: (ContextKeyExpr | null | undefined)[]): ContextKeyExpr[] {
    ...
    if (arr) {
      for (let i = 0, len = arr.length; i < len; i++) {
        const e: ContextKeyExpr | null | undefined = arr[i];
        if (!e) {
          continue;
        }
...
export interface IContextKeyService {
  ...
  bufferChangeEvents(callback: FunctionLike): void;
