import { Emitter, Event, GlobalEvent } from '@/base/common/event';
...
import { IKeybindingItem } from '@/platform/keyboard/common/keyboard';
...
import { ContextCommandService } from '@/platform/commands/electron-browser/contextCommandService';

import {
  IContextCommandService,
  IRegisterCommandContext,
} from '@/platform/commands/electron-main/contextCommand';
