import { isEqual, isEqualOrParent, URI } from '@/base/common/uri';
import { IDisposable } from '@/base/common/lifecycle';
import { Emitter, Event } from '@/base/common/event';

import { isUndefinedOrNull } from '@/base/common/types';
import { CancellationToken } from '@/base/common/async';
import { createDecorator } from '@/platform/instantiation/common/instantiation';

import { ReadableStream, ReadableStreamEvents } from '@/base/common/stream';
import {
  FileOperationError,
  FileOperationResult,
  IWriteFileOptions,
} from '@/platform/files/common/fileService';
import { startsWithIgnoreCase } from '@/base/common/string';
