...
import { Workspace } from '@/platform/workspace/electron-main/workspace';
import {
  IWorkspace,
...
import { originalFSPath, URI } from '@/base/common/uri';
...
import { WorkspaceChannel } from '@/platform/workspace/node/workspace';

import { Schemas } from '@/base/common/network';
import { normalizeNFC } from '@/base/common/normalize';
